...
if __name__ == "__main__":
    folders = [
        #bio
        "temp/bbox/bio/cap1_corpul_uman_celula/grile/done",
        "temp/bbox/bio/cap2_oasele_articulatiile/grile/done",
        "temp/bbox/bio/cap3_tesuturi_excitabile/grile/done",
        "temp/bbox/bio/cap4_sistemul_nervos/grile/done",
        "temp/bbox/bio/cap5_organe_de_simt/grile/done",
        "temp/bbox/bio/cap6_sistemul_endocrin_metabolism/grile/done",
        "temp/bbox/bio/cap7_sangele/grile/done",
        "temp/bbox/bio/cap8_sistemul_circulator/grile/done",
        "temp/bbox/bio/cap9_sistemul_respirator/grile/done",
        "temp/bbox/bio/cap10_sistemul_digestiv/grile/done",
        "temp/bbox/bio/cap11_sistemul_urinar/grile/done",
        "temp/bbox/bio/cap12_sistemul_reproducator/grile/done",
